...
-- 회원 탈퇴(SECESSION_FN 컬럼의 값을 'Y'로 변경)
UPDATE "MEMBER" SET
SECESSION_FN = 'Y'
WHERE MEMBER_NO = ?
AND MEMBER_PW = ?;
...
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 1번', DEFAULT, DEFAULT, 5, 3);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 2번', DEFAULT, DEFAULT, 5, 3);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '댓글 샘플 3번', DEFAULT, DEFAULT, 5, 3);
